# This migration comes from compass_ae_business_suite (originally 20150125232657)
class AddProductFeatureTypesBusinessModule

  def self.up

    # create the module
    new_module = BusinessModule.create(
      description: 'Product Feature Types',
      internal_identifier: 'product_feature_types',
      data_manager_name: 'ProductFeatureTypes',
      root_model: 'ProductFeatureType',
      can_create: true,
      can_associate: true,
      is_template: true
    )
    ...
    organizer_view = OrganizerView.new(
      description: 'ProductFeatureTypes Organizer Template',
      title: 'Product Feature Types Organizer Template',
    ...
    web_view = WebView.new(
      description: 'ProductFeatureTypes Web View Template',
      title: 'Product Feature Types Web View Template',
      can_edit_detail_view: true,
      can_edit_list_view: true
    )
    ...
    # add fields
    [
      ['Parent Feature Type', 'parent_feature_type', 'product_feature_type', []],
    ...
    %w{parent_feature_type description}.each do |field_iid|
