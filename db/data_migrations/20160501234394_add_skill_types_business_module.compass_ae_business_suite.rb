# This migration comes from compass_ae_business_suite (originally 20150102194134)
class AddSkillTypesBusinessModule
  ...
  def self.up
    ...
    new_module = BusinessModule.create(
      ...
      internal_identifier: 'skill_types',
      data_manager_name: 'SkillTypes',
      root_model: 'SkillType',
      can_create: true,
      can_associate: false,
      is_template: true
    )
    ...
    organizer_view = OrganizerView.new(
      description: 'SkillTypes Organizer Template',
      title: 'SkillTypes Organizer Template',
      icon_src: '/assets/erp_app/shared/skill_type_64x64.png',
    ...
    web_view = WebView.new(
      description: 'SkillTypes Web View Template',
      title: 'SkillTypes Web View Template',
      can_edit_detail_view: true,
      can_edit_list_view: true
    )
  ...
  def self.down
    BusinessModule.find_by_internal_identifier('skill_types').destroy
  end
end
